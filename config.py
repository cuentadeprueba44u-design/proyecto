...
DEFAULT_RENDER_EXTERNAL = 'postgresql://hydra:janOddtOHJ0WZvcrHwsNZq7jFcN4JIvs@dpg-d45e15p5pdvs73c00n70-a.oregon-postgres.render.com/control_acceso'
...
def get_db_config():
    ...
    return {
        ...
        'password': os.getenv('DB_PASSWORD', 'janOddtOHJ0WZvcrHwsNZq7jFcN4JIvs'),
        'host': os.getenv('DB_HOST', 'dpg-d45e15p5pdvs73c00n70-a.oregon-postgres.render.com'),
